...
void blur(string path,string filePath, int blur_size) //Loai (Done)
{
    Image image(path);
...
void Pixelate(string path,string filePath) {
    Image image(path);
    int Pixel_Size = 6 ;  // This variable handles the size of each pixel
